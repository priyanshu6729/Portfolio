...
export const projects = [
  ...
  // ═══════════════════════════════════════════════════
  {
    ...
    impact: 'Deployed for Northern Railways, Charbagh Lucknow · Reduced manual paperwork by 70%',
    links: {
 ...
 },
 {
  ...
  // ═══════════════════════════════════════════════════
  {
    slug: 'transmission-portfolio',
    title: 'Transmission from the Void',
    tagline: 'This portfolio website — a cinematic, deep-space themed developer portfolio with custom force-directed graphs and canvas starfield.',
    type: 'personal',
    featured: false,
    status: 'completed',
    year: 2026,
    tech: ['Next.js 15', 'Tailwind CSS v4', 'Canvas API', 'Force Graph', 'GSAP'],
    impact: 'Custom design system · Zero UI library dependencies',
    links: {},
    problem: 'Most developer portfolios use generic templates and lack personality — failing to demonstrate the craft they claim to possess.',
    approach: 'Designed and engineered a bespoke portfolio from scratch with a "transmission from deep space" narrative. Built a custom force-directed skill graph (pure JS, no D3), parallax canvas starfield, terminal-style UI patterns, and a cinematic loading sequence. Every component is hand-crafted.',
    outcome: 'A portfolio that demonstrates full-stack craft through its own existence — from design tokens to SVG physics to canvas rendering, it\'s a working demo of the skills it describes.',
  },
  {
    slug: 'cryptoplace',
    title: 'CryptoPlace',
